...
const PROJECTS = {
    ...
    'renda-rs': {
        ...
        tags: ['Leaflet','IBGE API','JavaScript','Dados Públicos'],
        title: 'Renda e Desigualdade no RS',
        subtitle: '497 municípios: concentração vs. nível de renda',
        desc: 'Projeto em andamento. Mapa interativo com dados públicos do IBGE (SIDRA) buscados em lote via API, cobrindo hoje os 497 municípios do Rio Grande do Sul, com meta de expandir a cobertura para o Brasil inteiro. Alternador entre duas visões que costumam ser confundidas: concentração de renda (razão renda média/mediana) e nível de renda (quanto a pessoa típica ganha). Porto Alegre lidera em concentração entre as cidades grandes, mas Redentora, com a menor renda absoluta do estado, não é a mais desigual: as duas coisas não são a mesma.',
        metrics: [{ num:'497', label:'Municípios cobertos' }, { num:'1,88', label:'Razão em Porto Alegre' }],
        github: 'https://github.com/henriquereolonpain-sys/renda-desigualdade-rs',
        demo: 'https://henriquepain.com.br/renda-desigualdade-rs/', video: '', embed: '', embed_en: '',
        desc_en: 'Project in progress. Interactive map with public IBGE data (SIDRA) fetched in batch via API, currently covering all 497 municipalities of Rio Grande do Sul, with the goal of expanding coverage nationwide. A toggle between two views that are often confused: income concentration (mean/median income ratio) and income level (what the typical resident earns). Porto Alegre leads in concentration among large cities, but Redentora, with the state\'s lowest absolute income, isn\'t the most unequal: the two aren\'t the same thing.',
        images: [],
    },
};
...
const INDEXED_TRANS = {
    ...
    vcLabels: { sel:'.vc-label', v:[
        ['Renda e Desigualdade no RS','Income & Inequality in RS'],
        ['Mapa de Acidentes de Trânsito','Traffic Accident Map'],
        ['Milho × Clima no RS','Corn × Climate in RS'],
    ...
    vcDescs: { sel:'.vc-desc', v:[
        ['497 municípios do RS mapeados','All 497 RS municipalities mapped'],
        ['7.300+ notícias cruzadas com a PRF','7,300+ articles cross-checked with PRF'],
        ['Elasticidade com 99% de confiança','Elasticity at 99% confidence'],
    ...
    vcValues: { sel:'.vc-value', v:[
        ...
        ['Databricks · PySpark · Delta Lake','Databricks · PySpark · Delta Lake'],
        ['Power BI · SQL · DAX','Power BI · SQL · DAX'],
    ]},
    aboutParas: { sel:'.about-text p', v:[
        [null,null],
        ['Meu diferencial está em unir domínio técnico de dados (ETL, Data Warehouse, Machine Learning) com conhecimento direto do processo físico que os origina. Hoje isso significa estar no chão de fábrica mapeando gargalos e custos de produção, não só analisando planilhas depois que o problema já aconteceu. Essa proximidade com a origem do dado é o que me permite traduzir requisitos de negócio em arquiteturas que realmente refletem a operação.','My edge lies in combining technical data expertise (ETL, Data Warehouse, Machine Learning) with direct knowledge of the physical process that originates it. Today that means being on the factory floor mapping bottlenecks and production costs, not just analyzing spreadsheets after the problem has already happened. This closeness to where the data comes from is what lets me translate business requirements into architectures that truly reflect the operation.'],
    ...
    badgeTexts: { sel:'.project-badge-live .live-text', v:[
        ['Projeto principal · Concluído','Flagship project · Completed'],
        ['Em andamento · Meta: Brasil','In progress · Goal: nationwide'],
    ]},
    ...
    highlightLabels: { sel:'.highlight-label', v:[
        ...
        ['Municípios cobertos','Municipalities covered'],
        ['Razão em Porto Alegre','Porto Alegre ratio'],
    ...
    projSubtitles: { sel:'.project-subtitle', v:[
        ...
        ['497 municípios: concentração vs. nível de renda','497 municipalities: concentration vs. income level'],
    ...
    skillTitles: { sel:'.skill-cat-title', v:[
        ...
        ['Processos & Produção','Processes & Production'],
    ]},
